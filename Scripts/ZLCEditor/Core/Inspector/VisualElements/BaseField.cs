...
namespace ZLCEditor.Inspector.VisualElements
{
    ...
    public abstract class BaseField<TValueType> : BindableElement, INotifyValueChanged<TValueType>, IMixedValueSupport
    {
        ...
        /// label的宽度比例
        /// </summary>
        static CustomStyleProperty<float> _labelWidthRatioProperty = new CustomStyleProperty<float>("--zlc-property-field-label-width-ratio");
        /// <summary>
        /// label的边距
        /// </summary>
        static CustomStyleProperty<float> _labelExtraPaddingProperty = new CustomStyleProperty<float>("--zlc-property-field-label-extra-padding");
        /// <summary>
        /// label的最小宽度
        /// </summary>
        static CustomStyleProperty<float> _labelBaseMinWidthProperty = new CustomStyleProperty<float>("--zlc-property-field-label-base-min-width");
