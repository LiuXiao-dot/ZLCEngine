    ...
    public class JsonMapper
    {
            ...
            int depth)
        {
            ...
            foreach (PropertyMetadata p_data in props) {
                object[] skipAttributesList = p_data.Info.GetCustomAttributes(typeof(JsonIgnore), true);
                ICollection<Attribute> skipAttributes = skipAttributesList as ICollection<Attribute>;
